...
test("beranda menjelaskan ekosistem tanpa mengulang daftar project", async () => {
  ...
  assert.match(page, /Bagikan,.*Temukan,.*Berkolaborasi/s);
  assert.match(page, /Bagikan project terbaikmu, temukan tempat kontribusi, dan bangun portfolio dengan kolaborasi/);
  ...
  assert.match(page, /Ini contohnya/);
