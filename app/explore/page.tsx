...
async function Board({ params: paramsPromise }: { params: SearchParams }) {
  ...
  const activeControlCount = [stage, tag, role, needs, sort === "for-you" ? "" : sort].filter(Boolean).length;
            ...
            <div className="collaboration-filter-controls">
              ...
              <div className="collaboration-control">
                ...
                <SearchableFilter
                  ...
                  hidden={{ stage, role, q, searchBy: searchBy === "role" ? searchBy : "", needs, lane: sort === "for-you" ? "" : sort }}
                />
              </div>
              ...
              <div className="collaboration-control">
                ...
                <SortSelect
                  ...
                  hidden={{ tag, role, q, searchBy: searchBy === "role" ? searchBy : "", needs, lane: sort === "for-you" ? "" : sort }}
                />
              </div>
              ...
              <div className="collaboration-control">
                ...
                <SortSelect
                  ...
                  hidden={{ stage, tag, role, q, searchBy: searchBy === "role" ? searchBy : "", lane: sort === "for-you" ? "" : sort }}
                />
              </div>
            </div>
          </details>
